...
type TimeSlot struct {
	...
	StartTime time.Time `gorm:"column:start_time;not null" json:"startTime" example:"09:00"`
	EndTime   time.Time `gorm:"column:end_time;not null" json:"endTime" example:"10:00"`
